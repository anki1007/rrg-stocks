...
# Sector/Thematic Indices for RRG Analysis
SECTOR_INDICES = {
    "CNXAUTO": {"name": "NIFTY AUTO", "industry": "AUTO"},
    "^NSEBANK": {"name": "NIFTY BANK", "industry": "BANKNIFTY"},
    "NIFTY_CHEMICALS.NS": {"name": "NIFTY CHEMICAL", "industry": "CHEMICAL"},
    "^CNXCMDT": {"name": "NIFTY COMMODITIES", "industry": "COMMODITIES"},
    "NIFTY_CONSR_DURBL.NS": {"name": "NIFTY CONSUMER DURABLES", "industry": "CONSUMER DURABLES"},
    "^CNXCONSUM": {"name": "NIFTY CONSUMPTION", "industry": "CONSUMPTION"},
    "NIFTY_CPSE.NS": {"name": "NIFTY CPSE", "industry": "CPSE"},
    "NIFTY_IND_DEFENCE.NS": {"name": "NIFTY IND DEFENCE", "industry": "DEFENCE"},
    "NIFTY_IND_DIGITAL.NS": {"name": "NIFTY DIGITAL", "industry": "DIGITAL"},
    "^CNXENERGY": {"name": "NIFTY ENERGY", "industry": "ENERGY"},
    "NIFTY_FIN_SERVICE.NS": {"name": "NIFTY FINANCIAL SERVICE", "industry": "FINANCIAL SERVICE"},
    "^CNXFMCG": {"name": "NIFTY FMCG", "industry": "FMCG"},
    "NIFTY_HEALTHCARE.NS": {"name": "NIFTY HEALTHCARE", "industry": "HEALTHCARE"},
    "^CNXINFRA": {"name": "NIFTY INFRA", "industry": "INFRA"},
    "^CNXIT": {"name": "NIFTY IT", "industry": "IT"},
    "^CNXMEDIA": {"name": "NIFTY MEDIA", "industry": "MEDIA"},
    "^CNXMETAL": {"name": "NIFTY METAL", "industry": "METAL"},
    "NIFTYMIDCAP150.NS": {"name": "NIFTY MIDCAP 150", "industry": "MIDCAP 150"},
    "^NSEMDCP50": {"name": "NIFTY MIDCAP 50", "industry": "MIDCAP 50"},
    "^CNXMNC": {"name": "NIFTY MNC", "industry": "MNC"},
    "^NSEI": {"name": "NIFTY 50", "industry": "NIFTY"},
    "^NSMIDCP": {"name": "NIFTY NEXT 50", "industry": "NIFTY JR"},
    "NIFTY_OIL_AND_GAS.NS": {"name": "NIFTY OIL AND GAS", "industry": "OIL AND GAS"},
    "^CNXPHARMA": {"name": "NIFTY PHARMA", "industry": "PHARMA"},
    "NIFTYPVTBANK.NS": {"name": "NIFTY PRIVATE BANK", "industry": "PRIVATE BANK"},
    "^CNXPSE": {"name": "NIFTY PSE", "industry": "PSE"},
    "^CNXPSUBANK": {"name": "NIFTY PSUBANK", "industry": "PSUBANK"},
    "^CNXREALTY": {"name": "NIFTY REALTY", "industry": "REALTY"},
    "^CNXSERVICE": {"name": "NIFTY SERVICE", "industry": "SERVICE"}
}
...
if st.session_state.load_clicked:
    try:
        ...
        universe = load_universe("Sector/Thematic Indices")
...
if st.session_state.df_cache is not None:
    ...
    with col_main:
        ...
        with tab1:
            ...
            st.markdown(f"**{"Sector/Thematic Indices"} | {tf_name} | {period_name} | Benchmark: {bench_name}**")
            ...
            if animation_history:
                ...
                if anim_frames:
                    ...
                    fig_anim.update_layout(
                        ...
                        hovermode='closest',
                        title=dict(text=f"Animated RRG: {"Sector/Thematic Indices"} | {tf_name} | {bench_name}",
